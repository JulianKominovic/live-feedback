...
export default function FinalCTA() {
  return (
    <section className="relative flex flex-col items-center max-w-screen-lg gap-4 px-8 py-16 mx-4 my-16 overflow-hidden border lg:mx-auto border-white/10 rounded-3xl backdrop-blur-3xl bg-black/60">
